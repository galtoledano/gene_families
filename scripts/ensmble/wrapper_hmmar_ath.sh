...
#PBS -q itaym
#PBS -V
#PBS -e /groups/itay_mayrose/galtoledano/gene_families/error_logs/ensmble/hammer_ath.ERR
#PBS -o /groups/itay_mayrose/galtoledano/gene_families/error_logs/ensmble/hammer_ath.OUT
#PBS -p 3
...
python3 scripts/hmm_scan_result.py $data_path/results.txt $genome $results_path $e_value_threshold $species
