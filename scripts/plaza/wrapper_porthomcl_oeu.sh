...
#PBS -q itaym
#PBS -V
#PBS -e /groups/itay_mayrose/galtoledano/gene_families/error_logs/error_logs/porthomcl_oeu.ERR
#PBS -o /groups/itay_mayrose/galtoledano/gene_families/error_logs/error_logs/porthomcl_oeu.OUT
#PBS -p 3
...
sample_path=/groups/itay_mayrose/galtoledano/gene_families/plaza/oeu/
# inflation=2
