#!/bin/bash
#PBS -S /bin/bash
#PBS -N mouse_porthomcl
#PBS -r y
#PBS -q itaym
#PBS -V
#PBS -e /groups/itay_mayrose/galtoledano/gene_families/error_logs/plaza/porthomcl_mouse.ERR
#PBS -o /groups/itay_mayrose/galtoledano/gene_families/error_logs/plaza/porthomcl_mouse.OUT
#PBS -p 3
...
sample_path=/groups/itay_mayrose/galtoledano/gene_families/plaza/mouse/
# inflation=2
