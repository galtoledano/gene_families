#!/bin/bash
#PBS -S /bin/bash
#PBS -N human_porthomcl
#PBS -r y
#PBS -q itaym
#PBS -V
#PBS -e /groups/itay_mayrose/galtoledano/gene_families/error_logs/plaza/porthomcl_human.ERR
#PBS -o /groups/itay_mayrose/galtoledano/gene_families/error_logs/plaza/porthomcl_human.OUT
#PBS -p 3
...
sample_path=/groups/itay_mayrose/galtoledano/gene_families/plaza/human/
inflation=2
