...
#PBS -q itaym
#PBS -V
#PBS -e /groups/itay_mayrose/galtoledano/gene_families/error_logs/error_logs/porthomcl_osa.ERR
#PBS -o /groups/itay_mayrose/galtoledano/gene_families/error_logs/error_logs/porthomcl_osa.OUT
#PBS -p 3
