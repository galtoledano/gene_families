...
mcl $sample_name/8.all.par.tsv  --abc -I $inflation -t 4 -o $sample_name/8.all.par.group_$inflation

# add orphans
python /groups/itay_mayrose/galtoledano/gene_families/scripts/add_orphans.py $sample_name/0.input_faa/$strand.fasta $sample_name/8.all.par.group_$inflation