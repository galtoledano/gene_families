...
#PBS -q itaym
#PBS -V
#PBS -e /groups/itay_mayrose/galtoledano/gene_families/error_logs/hammer_sly.ERR
#PBS -o /groups/itay_mayrose/galtoledano/gene_families/error_logs/hammer_sly.OUT
#PBS -p 3
...
# hmmpress $parent_directory/data_base_profile.hmm
